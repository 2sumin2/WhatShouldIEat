...
public class Default_4_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.default_4_3);
    ...
    public void select4_3 (View v) {
        ...
        String value4_3 = selection + selection1 + selection3 + selection3_0 + v.getTag();
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putString("value", value4_3);
