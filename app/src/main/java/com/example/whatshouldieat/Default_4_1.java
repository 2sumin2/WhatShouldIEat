...
public class Default_4_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.default_4_1);
    ...
    public void select4_1 (View v) {
        ...
        String value4_1 = selection + selection1 + selection3 + selection3_2 + v.getTag();
        SharedPreferences.Editor editor = sharedPreferences.edit();

        editor.putString("value", value4_1);
